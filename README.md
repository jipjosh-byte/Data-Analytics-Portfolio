...
* **Objective:** Cleaned and analyzed classroom grade data to find top students, track passing rates, and spot who needs extra help.
* **Key Finding:** Used conditional formatting and automated logic (`=IF()`) to highlight student averages, showing that Carol was the top performer with an 81.67 average[cite: 3].

![Excel Table 1](Excel chart.png)

---

#### 📊 [Tableau – Spotify Audio Trends](./02-Dashboard-Visualisations/Tableau-PowerBI-Dashboards/)
...
#### 💻 [SQL – Global Demographics Analytics](./03-SQL-Relational-Databases/Global-Demographics-Analytics/)
...
#### 🐍 [Python – Student Exploratory Data Analysis](./04-Python-Jupyter-Notebooks/Student-Exploratory-Data-Analysis/)
